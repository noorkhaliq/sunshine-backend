...
(function () {
    ...
    var _sliderChangeEvent = 'pages.change.value';
    ...
    var makeSlider = function (spec$1) {
      ...
      return Slider.sketch({
        dom: dom$1('<div class="${prefix}-pages ${prefix}-hue-pages-container"></div>'),
        components: [
          Slider.parts['left-edge'](spec('<div class="${prefix}-hue-pages-black"></div>')),
          Slider.parts.spectrum({
            dom: dom$1('<div class="${prefix}-pages-gradient-container"></div>'),
            components: [spec('<div class="${prefix}-pages-gradient"></div>')],
            behaviours: derive$1([Toggling.config({ toggleClass: resolve('thumb-active') })])
          }),
          Slider.parts['right-edge'](spec('<div class="${prefix}-hue-pages-white"></div>')),
          Slider.parts.thumb({
            dom: dom$1('<div class="${prefix}-pages-thumb"></div>'),
            behaviours: derive$1([Toggling.config({ toggleClass: resolve('thumb-active') })])
          })
        ],
        onChange: onChange,
    ...
    var sketch$2 = function (rawSpec) {
      ...
      return Slider.sketch({
        dom: {
          tag: 'div',
          classes: [
            resolve('pages-' + spec$1.category + '-size-container'),
            resolve('slider'),
            resolve('pages-size-container')
          ]
        },
        onChange: onChange,
        onDragStart: function (slider, thumb) {
        ...
        components: [
          Slider.parts.spectrum({
            dom: dom$1('<div class="${prefix}-pages-size-container"></div>'),
            components: [spec('<div class="${prefix}-pages-size-line"></div>')]
          }),
          Slider.parts.thumb({
            dom: dom$1('<div class="${prefix}-pages-thumb"></div>'),
            behaviours: derive$1([Toggling.config({ toggleClass: resolve('thumb-active') })])
