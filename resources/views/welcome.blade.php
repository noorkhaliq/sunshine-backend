...
{{--    <link rel="stylesheet" href="{{asset('assets')}}/vendors/datatables.net-bs4/dataTables.bootstrap4.css">--}}
    ...
    <!-- endinject -->
    <!-- Plugin css for this products -->
    <link rel="stylesheet" href="{{asset('assets')}}/js/select.dataTables.min.css">
    <!-- End plugin css for this products -->
    <!-- inject:css -->
        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
            ...
            <div>
                <a class="navbar-brand brand-logo" href="{{route('dashboard')}}">
                    <h1 class="fw-bold hover:text-gray-900">Sun<span class="text-youtube">Shine</span></h1>
                </a>
            </div>
        </div>
    </nav>
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Sunshine Panel.</span>
