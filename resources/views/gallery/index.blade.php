        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title d-block" style="float:left;display: block">Gallery List</h4>
                            <a href="{{route('gallery.create')}}" class="btn btn-primary mb-5" style="float: right" >&plus;</a>
